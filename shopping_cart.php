            ...
            <form method="post" action="#">
              ...
              <fieldset>
                <table class="data-table cart-table" id="shopping-cart-table">
                  ...
                  <tbody>
                    <tr class="first odd">
                      <td class="image"><a class="product-image" title="Sample Product" href="product_detail.php"><img width="75" alt="Sample Product" src="images/book/image1.jpg"></a></td>
                      <td><h2 class="product-name"> <a href="product_detail.php">Người Giàu Có Nhất Thành Babylon</a> </h2></td>
                     ...
                     <!-- <td class="a-center hidden-table"><a class="link-wishlist1 use-ajax" href="#">Move</a></td>-->
                      <td class="a-center hidden-table"><span class="cart-price"> <span class="price">$99.00</span> </span></td>
                      <td class="a-center movewishlist"><input maxlength="12" class="input-text qty" title="Qty" size="4" value="1" name="cart[10522][qty]"></td>
                      <td class="a-center movewishlist"><span class="cart-price"> <span class="price">$99.00</span> </span></td>
                      <td class="a-center last"><a class="button remove-item" title="Remove item" href="#"><span><span>Remove item</span></span></a></td>
                    </tr>
                    <tr class="last even">
                      <td class="image"><a class="product-image" title="Sample Product" href="product_detail.php"><img width="75" alt="Sample Product" src="images/book/image2.jpg"></a></td>
                      <td><h2 class="product-name"> <a href="product_detail.php">Doremon</a> </h2></td>
                      <td class="a-center hidden-table"><a title="Edit item parameters" class="edit-bnt" href="#"></a></td>
                     <!-- <td class="a-center hidden-table"><a class="link-wishlist1 use-ajax" href="#">Move</a></td>-->
                      <td class="a-center hidden-table"><span class="cart-price"> <span class="price">$16.00</span> </span></td>
                      <td class="a-center movewishlist"><input maxlength="12" class="input-text qty" title="Qty" size="4" value="1" name="cart[10523][qty]"></td>
                      <td class="a-center movewishlist"><span class="cart-price"> <span class="price">$16.00</span> </span></td>
                      <td class="a-center last"><a class="button remove-item" title="Remove item" href="#"><span><span>Remove item</span></span></a></td>
                    </tr>
                    <tr class="last even">
                      <td class="image"><a class="product-image" title="Sample Product" href="product_detail.php"><img width="75" alt="Sample Product" src="images/book/image3.png"></a></td>
                      <td><h2 class="product-name"> <a href="product_detail.php">Từ điển Anh-Việt</a> </h2></td>
                      <td class="a-center hidden-table"><a title="Edit item parameters" class="edit-bnt" href="#"></a></td>
                     <!-- <td class="a-center hidden-table"><a class="link-wishlist1 use-ajax" href="#">Move</a></td>-->
                      <td class="a-center hidden-table"><span class="cart-price"> <span class="price">$65.00</span> </span></td>
                      <td class="a-center movewishlist"><input maxlength="12" class="input-text qty" title="Qty" size="4" value="1" name="cart[10523][qty]"></td>
                      <td class="a-center movewishlist"><span class="cart-price"> <span class="price">$65.00</span> </span></td>
                      <td class="a-center last"><a class="button remove-item" title="Remove item" href="#"><span><span>Remove item</span></span></a></td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table class="table shopping-cart-table-total" id="shopping-cart-totals-table">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td class="a-right"><strong><span class="price">$180.00</span></strong></td>
                    </tr>
                  </tfoot>
                  <tbody>
                    <tr>
                      <td colspan="1" class="a-left"> Tổng tiền </td>
                      <td class="a-right"><span class="price">$180.00</span></td>
                    </tr>
                  </tbody>
                </table>
                <ul class="checkout">
