            ...
            <div class="content">
              ...
              <ul class="form-list">
                <li>
                  ...
                  <br>
                  <input type="text" title="Email Address" class="input-text" id="email" value="" name="login[username]">
                </li>
                <li>
                  <label for="pass">Password <span class="required">*</span></label>
                  <br>
                  <input type="password" title="Password" id="pass" class="input-text" name="login[password]">
                </li>
              </ul>
